...
metros_quadrados = float(input("diga a quantidade de m2 a serem pintados:")) 
...
apenas_lata = math.ceil(metros_quadrados/lata_rendimento) 
apenas_lata_preco = apenas_lata * lata_preco
apenas_galao = math.ceil(metros_quadrados/galao_rendimento)    
apenas_galao_preco=apenas_galao * galao_preco  

qtd_latas_both = math.floor(metros_quadrados/lata_rendimento) 
qtd_galoes_both = math.ceil( (metros_quadrados % lata_rendimento) / galao_rendimento) 
